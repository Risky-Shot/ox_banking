...
const Bank: React.FC = () => {
  ...
  useNuiEvent('openBank', (data: Character) => {
    navigate('/');
    setVisible(true);
    console.log(' useNuiEvent "openBank" ' + JSON.stringify(data));
    setCharacter(data);
  });

  useNuiEvent('refreshCharacter', (data: Character) => {
    console.log('useNuiEvent "refreshCharacter"' +JSON.stringify(data));
    setCharacter(data)
  });
