...
const InvoiceTypeButtons: React.FC = () => {
  ...
  return (
    <div className="rounded-lg border shadow-sm">
      <Button
        onClick={() => setFilters((prev : any) => ({ ...prev, type: 'unpaid', page: 0, search: '', date: undefined }))}
      ...
      <Button
        onClick={() => setFilters((prev : any) => ({ ...prev, type: 'paid', page: 0, search: '', date: undefined }))}
      ...
      <Button
        onClick={() => setFilters((prev : any) => ({ ...prev, type: 'sent', page: 0, search: '', date: undefined }))}
